...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "relative z-[3] overflow-hidden h-8 px-3 py-1.5 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-xs font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button",
        className,
      )}
      {...props}
    >
      ...
      <span className="z-10 relative text-white font-semibold uppercase tracking-wide">
        {children}
      </span>
    </button>
  );
